...
<div class="sixteen wide computer column">
	...
	<div class="ui attached segment">
		...
		<div>
			<div id="bar-chart" data-source="{{url('konsultan/dashboard/rawat-jalan')}}" style="height: 300px;"></div>
		</div>
	</div>
</div>
<div class="sixteen wide mobile sixteen wide tablet ten wide computer column">
	...
	<div class="ui attached segment">
		<table id="table-pasien" width="100%" class="ui striped unstackable table" data-token="{{ csrf_token() }}" data-lang="{{ asset('/assets/datatables/i18n/indonesian.json') }}" data-source="{{ url('konsultan/dashboard/pasien-rawat-jalan') }}">
			<thead>
				<tr>
					<th>ID</th>
					<th>Nama</th>
...
<div class="sixteen wide mobile sixteen wide tablet six wide computer column">
	...
	<div class="ui attached segment">
		...
		<div style="margin: 0 auto;">
			<div data-source="{{ url('konsultan/dashboard/usia-per-tahun') }}" id="pie-chart" style="height: 300px;">
			</div>
		</div>
	</div>
</div>
...
@section('sidebar')
@include('konsultan.sidebar')
@stop
@section('left-menu')
@include('konsultan.left-menu')
@stop
@section('navbar')
@include('konsultan.navbar')
@stop
