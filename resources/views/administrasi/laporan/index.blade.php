@extends('administrasi.default') @section('title','Rekap Rawat Jalan Pasien: ') @section('content_title','Rekap Rawat Jalan Pasien') @section('content_sub_title', 'Data Pasien Yang Sudah Rawat Jalan') @section('content_title_icon')
<i class="big icons">
    <i class="icon user">
    </i>
...
<link rel="stylesheet" type="text/css" href="{{ asset('/assets/slickgrid/slick.grid.css') }}">
...
<script type="text/javascript" src="{{ asset('/assets/datatables/extensions/Select/js/dataTables.select.min.js') }}">


</script>
<script type="text/javascript" src="{{ asset('/assets/js/serialize-object.js') }}">


</script>
<script type="text/javascript" src="{{ asset('/assets/yadcf/jquery.dataTables.yadcf.js') }}">
</script>
<script type="text/javascript" src="{{ asset('/assets/jquery-input-mask/min/inputmask/inputmask.min.js') }}">
</script>
...
<div class="datatable-container">
  <table id="laporan" class="ui striped unstackable single line celled table" data-lang="{{ asset('/assets/datatables/i18n/indonesian.json')}}" data-token="{{ csrf_token() }}" width="100%" data-source="{{ url('administrasi/laporan/data-index?progres=0') }}">
    <thead>
      <tr>
        <th></th>
        <th>ID</th>
