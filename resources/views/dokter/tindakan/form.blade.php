<div class="ui small modal" id="modal-resep-insert">
  ...
  <div class="content">
    <form id="form-resep" data-hapus="{{ url('/dokter/rawat-jalan/delete-resep') }}" class="ui small form" data-token="{{ csrf_token() }}" data-id="{{ $rawat_jalan->id }}" action="{{ url('dokter/rawat-jalan/simpan-resep') }}">
      {!! csrf_field() !!}
      ...
      <div class="required field">
        <label>Resep:</label>
        <div id="resep-dropdown" data-id="{{$rawat_jalan->id}}" data-source="{{ url('/dokter/rawat-jalan/list-obat') }}" class="ui multiple search selection dropdown">
