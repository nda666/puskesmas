...
<form id="form-update-profile" class="ui equal width form" method="POST" action="{{ url(strtolower($pegawai->jabatan).'/profile/update') }}">
	{!! csrf_field() !!}
	...
	<div class="required two fields">
		<div class="required field">
			...
			<input type="text" value="{{$pegawai->nama }}" name="nama"></input>
		</div>
		<div class="required field">
			<label>Gender:</label>
			<div class="ui selection dropdown">
				<input type="hidden" value="{{$pegawai->jenis_kelamin }}" name="jenis_kelamin">
	...
	<div class="required two fields">
		<div class="required field">
			...
			<input placeholder="Tanggal Lahir" value="{{$pegawai->tgl_lahir->format('d-m-Y') }}" type="text" name="tgl_lahir"></input>
		</div>

		<div class="required field">
			<label>Agama:</label>
			<div class="ui selection dropdown">
				<input type="hidden" value="{{$pegawai->agama }}" name="agama">
				<i class="dropdown icon"></i>
	...
	<div class="required field">
		<label>No Telp:</label>
		<input placeholder="Nomor Telepon" value="{{$pegawai->no_telp }}" type="text" name="no_telp"></input>
	</div>
	<div class="required field">
		<label>Alamat:</label>
		<textarea name="alamat" rows="3">{{$pegawai->alamat }}</textarea>
	</div>
	<div class="field">
