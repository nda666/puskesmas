@extends('apoteker.default') @section('title','Rawat Jalan') @section('content_title','Rawat Jalan') @section('content_sub_title', 'List Pasien Sedang Rawat Jalan') @section('content_title_icon')
<i class="big icons">
    <i class="icon user">
    </i>
...
<div class="datatable-container">
  <table id="rawat-jalan" class="ui unstackable celled table" data-lang="{{ asset('/assets/datatables/i18n/indonesian.json')}}" data-token="{{ csrf_token() }}" width="100%" data-source="{{ url('apoteker/rawat-jalan/data-index?progres=0') }}">
    <thead>
      <tr>
