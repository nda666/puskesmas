...
<?php $__env->startSection('content_title','<i class="big icons"><i class="user thin icon"></i><i class="red mini corner heart icon"></i></i>Ubah Data Pasien'); ?>
...
<div id="update-pasien-form" class="ui segment">
	<form class="ui form" method="POST" action="<?php echo e(route('pasien/update/submit')); ?>">
		<?php echo csrf_field(); ?>

		<input type="hidden" name="id" value="<?php echo e($pasien->no_index); ?>">
		<div class="fields">
			<div class="eight wide field">
				<label>Nama Pasien</label>
				<input type="text" value="<?php echo e($pasien->nama_pasien); ?>" name="nama_pasien" placeholder="Nama Pasien">
			</div>
			<div class="eight wide field">
				<label>Nama Kepala Keluarga</label>
				<input type="text" value="<?php echo e($pasien->nama_kepala_keluarga); ?>" name="nama_kepala_keluarga" placeholder="Nama Kepala Keluarga">
			</div>
		</div>
		...
		<div class="fields">
			<div class="eight wide field">
				...
				<input type="text" value="<?php echo e($pasien->tgl_lahir); ?>" data-value="<?php echo e($pasien->tgl_lahir); ?>" class="datepicker" name="tgl_lahir" placeholder="Tanggal Lahir">
			</div>
			<div class="eight wide field">
				<label>Umur</label>
				<div class="ui right action input">
					<input type="text" value="<?php echo e($pasien->umur); ?>" name="umur" placeholder="Umur">
		...
		<div class="fields">
			<div class="eight wide field">
				...
				<div class="ui fluid selection dropdown">
					<input type="hidden" value="<?php echo e($pasien->jenis_kelamin); ?>" name="jenis_kelamin">
			...
			<div class="eight wide field">
				...
				<input type="text" value="<?php echo e($pasien->pekerjaan); ?>" name="pekerjaan" placeholder="Pekerjaan">			
			</div>	
		</div>

		<div class="field">
			<label>Agama</label>
			<input type="text" value="<?php echo e($pasien->agama); ?>" name="agama" placeholder="Agama">
		</div>
		
		<div class="field">
			<label>Alamat</label>
			<textarea name="alamat" rows="3" placeholder="Alamat"><?php echo e($pasien->alamat); ?></textarea>
		</div>
		
		<div class="field">
			<label>Kunjungan</label>
			<div class="ui fluid selection dropdown">
				<input type="hidden" value="<?php echo e($pasien->jenis_kunjungan); ?>" name="jenis_kunjungan">
				<i class="dropdown icon"></i>
		...
		<div class="field">
			...
			<div class="ui fluid selection dropdown">
				<input type="hidden" value="<?php echo e($pasien->jenis_kepesertaan); ?>" name="jenis_kepesertaan">
				<i class="dropdown icon"></i>
	...
	<script async defer src="<?php echo e(asset('assets/pickdate.js/translations/id_ID.js')); ?>" type="text/javascript" charset="utf-8"></script>
	<script async defer src="<?php echo e(asset('assets/pickdate.js/picker.js')); ?>" type="text/javascript" charset="utf-8"></script>
	<script async defer src="<?php echo e(asset('assets/pickdate.js/picker.date.js')); ?>" type="text/javascript" charset="utf-8"></script>
