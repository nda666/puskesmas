...
<link rel="stylesheet" href="<?php echo e(asset('/assets/jquery-ui-custom/jquery-ui.min.css')); ?>">
<?php $__env->stopSection(); ?>
...
<script src="<?php echo e(asset('/assets/jquery-input-mask/min/inputmask/inputmask.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('/assets/jquery-input-mask/min/inputmask/jquery.inputmask.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('/assets/jquery-input-mask/min/inputmask/inputmask.date.extensions.min.js')); ?>" type="text/javascript"></script>
...
<div class="ui segment">
	<form id="form-pasien" class="ui form" method="POST" action="<?php echo e(url('admin/pendaftaran')); ?>">
		<?php echo csrf_field(); ?>
