...
<div class="sixteen wide computer column">
	...
	<div class="ui attached segment">
		...
		<div>
			<div id="bar-chart" data-source="<?php echo e(url('dokter/dashboard/rawat-jalan')); ?>" style="height: 300px;"></div>
		</div>
	</div>
</div>
<div class="sixteen wide mobile sixteen wide tablet ten wide computer column">
	...
	<div class="ui attached segment">
		<table id="table-pasien" width="100%" class="ui striped unstackable table" data-token="<?php echo e(csrf_token()); ?>" data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>" data-source="<?php echo e(url('dokter/dashboard/pasien-rawat-jalan')); ?>">
			<thead>
				<tr>
					<th>ID</th>
					<th>Nama</th>
...
<div class="sixteen wide mobile sixteen wide tablet six wide computer column">
	...
	<div class="ui attached segment">
		...
		<div style="margin: 0 auto;">
			<div data-source="<?php echo e(url('dokter/dashboard/usia-per-tahun')); ?>" id="pie-chart" style="height: 300px;">
			</div>
		</div>
	</div>
</div>
...
<?php echo $__env->make('dokter.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('left-menu'); ?>
<?php echo $__env->make('dokter.left-menu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('navbar'); ?>
<?php echo $__env->make('dokter.navbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('dashboard.dashboard_default', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>