...
<?php $__env->startSection('content_title','<i class="icon hospital"></i>Ubah Data Pasien'); ?>
...
<div id="update-pasien-form" class="ui segment">
	<form class="ui form" method="POST" action="<?php echo e(route('pasien/update/submit', $pasien->no_index)); ?>">
		<?php echo csrf_field(); ?>
		...
		<div class="fields">
			<div class="eight wide field">
				...
				<input type="date" value="<?php echo e($pasien->tgl_lahir); ?>" data-value="<?php echo e($pasien->tgl_lahir); ?>" class="datepicker" name="tgl_lahir" placeholder="Tanggal Lahir">
			</div>
			<div class="eight wide field">
				<label>Umur</label>
