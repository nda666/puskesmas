<?php $__env->startSection('title','Resep Pasien - Belum'); ?>
...
<div class="ui blue top attached segment breadcrumb">
	<div class="ui breadcrumb">
		...
		<div class="active section"><i class="icon file text outline"></i>Resep Pasien - Belum</div>
	</div>
</div>
<?php $__env->stopSection(); ?>
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/resep-belum.js')); ?>"></script>
<?php $__env->stopSection(); ?>
