<div class="ui long small modal" id="modal-konsultasi-insert">
  ...
  <div class="content">
    <form id="form-konsultasi" data-update="<?php echo e(url('/konsultan/rawat-jalan/data-konsultasi-form')); ?>" class="ui equal width form" data-token="<?php echo e(csrf_token()); ?>" data-id="<?php echo e($rawat_jalan->id); ?>" action="<?php echo e(url('konsultan/rawat-jalan/simpan-konsultasi')); ?>">
      <?php echo csrf_field(); ?>
      ...
      <div class="two fields">
        <div class="required field">
          <label>Ke Poli:</label>
          <div id="poli-dropdown" data-source="<?php echo e(url('/konsultan/rawat-jalan/data-poli')); ?>" class="ui fluid search normal selection dropdown">
