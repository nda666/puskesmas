 <?php $__env->startSection('title','Pendaftaran Anggota & Rawat Jalan'); ?> <?php $__env->startSection('content_title','Pendaftaran Anggota & Rawat Jalan'); ?> <?php $__env->startSection('content_sub_title', 'Pendaftaran Anggota Baru dan Pendaftaran Rawat Jalan'); ?> <?php $__env->startSection('content_title_icon'); ?>
<i class="big icons">
<i class="icon user"></i>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('/assets/datatables/media/css/dataTables.responsive.min.css')); ?>">
<style type="text/css">
  .ui.modal>.close {
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/pendaftaran-rawat-jalan.min.js')); ?>"></script>
...
<div class="datatable-container">
    ...
    <table width="100%" id="data-pasien" class="ui definition unstackable celled table" data-token="<?php echo e(csrf_token()); ?>" data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>" data-delete="<?php echo e(url('administrasi/pendaftaran/delete-pasien')); ?>" data-update="<?php echo e(url('administrasi/pendaftaran/data-pasien')); ?>" data-source="<?php echo e(url('administrasi/pendaftaran/list-pasien')); ?>">
      <thead>
        <tr>
