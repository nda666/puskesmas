<?php $__env->startSection('title','Management Data Konsultasi'); ?>
<?php $__env->startSection('content_title','Management Data Konsultasi'); ?>
<?php $__env->startSection('content_title_icon'); ?>
<i class="big icons">
<i class="file database orange icon"></i>
<i class="icon corner treatment"></i>
</i>
...
<div class="ui breadcrumb">
	<div class="ui breadcrumb">
		...
		<div class="active section"><i class="icon treatment"></i>Management Ruang Konsultasi</div>
	</div>
</div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content_sub_title', 'Management dan Laporan Data Konsultasi'); ?>
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/management-pegawai.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<div class="datatable-container">
	<table data-token="<?php echo e(csrf_token()); ?>"
		data-source="<?php echo e(url('administrasi/json/management-pegawai')); ?>"
		data-token="<?php echo e(csrf_token()); ?>"
		data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>"
		data-update="<?php echo e(url('ajax/management-pegawai/update')); ?>" data-delete="<?php echo e(url('ajax/management-pegawai/delete')); ?>"
		id="data-pegawai" class="ui unstackable blue single line celled table" width="100%">
		<thead>
			<tr>
				<th>ID</th>
				<th>NIP</th>
...
<?php echo $__env->make('administrasi.management.form.add-edit-pegawai', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
