<?php $__env->startSection('title','Belum Konsultasi'); ?>
<?php $__env->startSection('content_title','Belum Konsultasi'); ?>
<?php $__env->startSection('content_title_icon'); ?>
<i class="big icons">
<i class="icon treatment"></i>
<i class="icon corner red minus"></i>
</i>
...
<div class="ui blue top attached segment breadcrumb">
	<div class="ui breadcrumb">
		...
		<div class="active section"><i class="icon treatment"></i>Belum Konsultasi</div>
	</div>
</div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content_sub_title', 'List pasien ter-data belum konsultasi'); ?>
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/belum-konsultasi.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<div class="datatable-container">
	<table data-token="<?php echo e(csrf_token()); ?>"
		data-source="<?php echo e(url('administrasi/belum-konsultasi/json/data-pasien')); ?>"
		data-token="<?php echo e(csrf_token()); ?>"
		data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>"
		data-update="<?php echo e(url('ajax/belum-konsultasi/update')); ?>" data-delete="<?php echo e(url('ajax/belum-konsultasi/delete')); ?>"
