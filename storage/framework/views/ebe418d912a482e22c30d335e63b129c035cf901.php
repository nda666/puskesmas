...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/view-laporan.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/view-laporan-tindakan.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/view-laporan-resep.min.js')); ?>"></script>
...
<div class="sixteen wide column no bottom padding">
  <div id="tab-rawat-jalan" class="ui stackable five item menu">
    <a class="item" data-tab="data-pasien">
      <i class="user icon"></i>Administrasi
    </a>
    ...
    <a class="link green item" data-token="<?php echo e(csrf_token()); ?>" data-id="<?php echo e($rawat_jalan->id); ?>" data-action="<?php echo e(url('/administrasi/rawat-jalan/selesai')); ?>" data-progres="1" data-force="false" id="selesai-rawat-jalan"><i class="check icon"></i>Selesai Rawat Jalan</a> <?php else: ?>
    <a class="link red item" data-action="<?php echo e(url('/administrasi/rawat-jalan/selesai')); ?>" data-token="<?php echo e(csrf_token()); ?>" data-id="<?php echo e($rawat_jalan->id); ?>" data-progres="0" data-force="true" id="selesai-rawat-jalan"><i class="close icon"></i>Batalkan Selesai</a> <?php endif; ?>
  </div>
  ...
  <div class="ui active tab vertical segment" data-tab="data-konsultasi">
    <div class="datatable-container">
      <table id="data-konsultasi" class="ui unstackable celled table" data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>" data-id="<?php echo e($rawat_jalan->id); ?>" data-token="<?php echo e(csrf_token()); ?>" width="100%"  data-source="<?php echo e(url('administrasi/laporan/data-konsultasi/'.$rawat_jalan->id)); ?>">
        <thead>
          <tr>
            <th>ID</th>
      ...
      <?php echo $__env->make('administrasi.laporan.view.konsultasi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </div>

  <?php /* Data Tindakan */ ?>
  <div class="ui tab vertical segment" data-tab="data-tindakan">
      <?php echo $__env->make('administrasi.laporan.view.tindakan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </div>

  <?php /* Data Resep */ ?>
  <div class="ui tab vertical segment" data-tab="data-resep">
    <div class="datatable-container">
      <table id="data-konsultasi-resep" class="ui celled table" data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>" data-pasien="<?php echo e($rawat_jalan->pasien->id); ?>" data-token="<?php echo e(csrf_token()); ?>" width="100%" data-source="<?php echo e(url('administrasi/laporan/data-resep/'.$rawat_jalan->id)); ?>">
        <thead>
        <tr>
          <th>ID</th>
          <th>Resep</th>
