<div class="ui long small modal" id="modal-insert">
	...
	<div class="content">
		<form enctype="multipart/form-data" id="form-insert" data-update="<?php echo e(url('administrasi/dokter/dokter-detail')); ?>" class="ui equal width form"
			data-token="<?php echo e(csrf_token()); ?>"
			action="<?php echo e(url('administrasi/dokter/create')); ?>">
			<?php echo csrf_field(); ?>
			...
			<div class="required two fields">
				...
				<div class="field">
					<label>Poli:</label>
					<div id="poli-dropdown" data-source="<?php echo e(url('administrasi/dokter/data-poli')); ?>" class="ui selection search dropdown">
