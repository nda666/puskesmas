<div class="ui small basic modal" id="modal-insert">
    ...
    <div style="width: 350px; margin: 0 auto;" class="ui segment">
      ...
      <form id="form-insert" data-delete="{{ url('administrasi/poli/delete') }}" data-update="{{ url('administrasi/poli/poli-detail') }}" class="ui equal width form"
  			data-token="{{ csrf_token() }}"
  			action="{{ url('administrasi/poli/create') }}">
  			{!! csrf_field() !!}
