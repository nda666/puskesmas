<div class="ui small basic modal" id="modal-insert">
    ...
    <div style="width: 350px; margin: 0 auto;" class="ui segment">
      ...
      <form id="form-insert" data-delete="{{ url('administrasi/obat/delete') }}" data-update="{{ url('administrasi/obat/obat-detail') }}" class="ui equal width form"
  			data-token="{{ csrf_token() }}"
  			action="{{ url('administrasi/obat/create') }}">
  			{!! csrf_field() !!}
