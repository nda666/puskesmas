@extends('administrasi.default') @section('title','Data Pegawai') @section('content_title','Management Pegawai') @section('content_sub_title','Tambah dan Ubah Data Pegawai') @section('content_title_icon')
<i class="big icons">
...
<script type="text/javascript" src="{{ asset('/assets/js/administrasi/pegawai.min.js') }}"></script>
@stop @section('content')
<div class="sixteen wide column computer">

	<div class="datatable-container">
		<table data-token="{{csrf_token()}}" data-source="{{ url('administrasi/pegawai/data-pegawai') }}" data-token="{{ csrf_token() }}" data-lang="{{ asset('/assets/datatables/i18n/indonesian.json') }}" data-update="{{ url('ajax/management-pegawai/update') }}"
				data-delete="{{ url('ajax/management-pegawai/delete') }}" id="data-pegawai" class="ui unstackable definition celled table" width="100%">
			<thead>
				<tr>
...
@include('administrasi.pegawai.form.add-edit-pegawai')
