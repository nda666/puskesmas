<div class="ui long small modal" id="modal-insert">
	...
	<div class="content">
		<form enctype="multipart/form-data" id="form-insert" data-update="{{ url('administrasi/pegawai/data-pegawai-detail') }}" class="ui equal width form"
			data-token="{{ csrf_token() }}"
			action="{{ url('administrasi/pegawai/create') }}">
			{!! csrf_field() !!}
