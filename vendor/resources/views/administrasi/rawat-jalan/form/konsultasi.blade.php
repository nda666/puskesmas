<div class="ui long small modal" id="modal-konsultasi-insert">
  ...
  <div class="content">
    <form id="form-konsultasi" data-update="{{ url('/administrasi/rawat-jalan/data-konsultasi-form') }}" class="ui equal width form" data-token="{{ csrf_token() }}" data-id="{{ $rawat_jalan->id }}" action="{{ url('administrasi/rawat-jalan/simpan-konsultasi') }}">
      {!! csrf_field() !!}
      ...
      <div class="two fields">
        <div class="required field">
          <label>Ke Poli:</label>
          <div id="poli-dropdown" data-source="{{ url('/administrasi/rawat-jalan/data-poli') }}" class="ui fluid search normal selection dropdown">
