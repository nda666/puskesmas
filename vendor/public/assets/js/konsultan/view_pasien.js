    ...
    table = $('#data-konsultasi').DataTable({
        ...
        buttons: [{
            ...
            action: function(e, dt, node, config) {
                ...
                var $id_pasien = $('#data-konsultasi').attr('data-pasien'),
                    $id = id_ar;
                swal({
                    title: 'Hapus?',
                    ...
                    swal.disableButtons();
                    $.ajax({
                        url: '/konsultan/ajax/pasien/delete-konsultasi',
                        type: 'DELETE',
                        data: {
                            id: $id,
                            id_pasien: $id_pasien,
                            _token: $('#data-konsultasi').data('token')
                        },
            ...
            text: '<i class="send icon"></i>Kirim',
            className: 'teal',
            action: function() {
                var token = $('#data-konsultasi').data('token'),
                    url = '/konsultan/ajax/selesai-konsultasi',
                    id_pasien = $('#data-konsultasi').data('pasien');
                swal({
                    title: 'Kirim data pasien ke Dokter?',
                    text: 'Anda tidak bisa mengubah data pasien ini apabila sudah tersimpan!',
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
