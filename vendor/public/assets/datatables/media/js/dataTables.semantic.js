...
(function(window, document, undefined) {
    var factory = function($, DataTable) {
        ...
        $.extend(true, DataTable.defaults, {
            dom: "<'left aligned eight wide column'l><'right aligned eight wide column'f>" + "<'sixteen wide column'tr>" + "<'left aligned four wide column'i><'right aligned twelve wide column'p>",
            renderer: 'semantic'
        });
        ...
        DataTable.ext.renderer.pageButton.semantic = function(settings, host, idx, buttons, page, pages) {
            ...
            attach($(host).empty().html('<div class="ui small pagination menu"/>').children('div'), buttons);
            if (activeEl) {
