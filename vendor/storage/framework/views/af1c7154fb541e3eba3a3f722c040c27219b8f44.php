    ...
    <div class="ui grid">
      ...
      <div class="right aligned ten wide column computer">
        <div class="ui breadcrumb">
          ...
          <div class="section">
            <i class="icon red heart"></i>Rawat Jalan</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="datatable-container">
  <table id="rawat-jalan" class="ui striped unstackable single line celled table" data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>" data-token="<?php echo e(csrf_token()); ?>" width="100%" data-source="<?php echo e(url('konsultan/rawat-jalan/data-index?progres=0')); ?>">
    <thead>
      <tr>
        <th>ID</th>
        <th>Nama</th>
