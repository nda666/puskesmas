 <?php $__env->startSection('title','Data obat'); ?> <?php $__env->startSection('content_title','Data obat'); ?> <?php $__env->startSection('content_sub_title','Tambah, ubah, hapus data obat'); ?> <?php $__env->startSection('content_title_icon'); ?>
...
<div class="sixteen wide column computer">
	...
	<div class="datatable-container">
		<table data-token="<?php echo e(csrf_token()); ?>" data-source="<?php echo e(url('apoteker/obat/data-index')); ?>" data-token="<?php echo e(csrf_token()); ?>" data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>" id="data-obat" class="ui unstackable definition celled table" width="100%">
			<thead>
				<tr>
...
<?php echo $__env->make('apoteker.obat.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
