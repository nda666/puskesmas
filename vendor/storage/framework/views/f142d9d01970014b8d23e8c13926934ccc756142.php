...
<div class="ui blue top attached segment breadcrumb">
	<div class="ui breadcrumb">
		...
		<a href="<?php echo e(url('administrasi/sudah-konsultasi/')); ?>" class="section"><i class="icon treatment"></i>Sudah Konsultasi</a>
		<i class="right chevron icon divider"></i>
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/sudah-konsultasi-view.js')); ?>"></script>
<?php $__env->stopSection(); ?>
