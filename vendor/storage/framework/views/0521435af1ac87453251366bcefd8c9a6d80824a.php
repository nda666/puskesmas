<div class="ui small basic modal" id="modal-insert">
    ...
    <div style="width: 350px; margin: 0 auto;" class="ui segment">
      ...
      <form id="form-insert" data-delete="<?php echo e(url('administrasi/obat/delete')); ?>" data-update="<?php echo e(url('administrasi/obat/obat-detail')); ?>" class="ui equal width form"
  			data-token="<?php echo e(csrf_token()); ?>"
  			action="<?php echo e(url('administrasi/obat/create')); ?>">
  			<?php echo csrf_field(); ?>

  			<input type="hidden" name="id">
				<div class="action required field">
          <label>Kode:</label>
          <input placeholder="Kode Obat" type="text" name="kode" />
        </div>
				<div class="action required field">
          <label>Nama:</label>
          <input placeholder="Nama Obat" type="text" name="nama" />
        </div>
