<?php $__env->startSection('title','Management Data & Laporan: Poli'); ?>
<?php $__env->startSection('content_title','Management Data & Laporan: Poli'); ?>
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/management-poli.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<div class="datatable-container">
	<table data-token="<?php echo e(csrf_token()); ?>"
		data-source="<?php echo e(url('administrasi/json/management-poli')); ?>"
		data-token="<?php echo e(csrf_token()); ?>"
		data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>"
		data-update="<?php echo e(url('ajax/management-poli/update')); ?>" data-delete="<?php echo e(url('ajax/management-poli/delete')); ?>"
		id="data-poli" class="ui definition unstackable blue single line celled table" width="100%">
		<thead>
			<tr>
				<th></th>
				<th>ID</th>
...
<?php echo $__env->make('administrasi.management.form.add-edit-poli', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
