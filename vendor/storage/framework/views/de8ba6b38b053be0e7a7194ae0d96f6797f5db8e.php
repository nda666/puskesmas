...
<html>
	<head>
		...
		<title>Ruang Dokter - <?php echo $__env->yieldContent('title'); ?></title>
		...
		<script src="<?php echo e(asset('assets/js/administrasi/administrasi.js')); ?>" type="text/javascript" charset="utf-8"></script>
	</head>
		...
		<div class="pusher context-sidebar">
			<div class="main content">
				...
				<div id="loaded-content" class="ui row grid">
					...
					<div id="footer">
						<div class="ui vertical teal center aligned segment">
