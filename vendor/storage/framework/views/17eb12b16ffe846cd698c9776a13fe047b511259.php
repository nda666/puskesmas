<nav data-counter="<?php echo e(url('dokter/json/counter')); ?>" class="ui left-menu blue-black inverted left fixed vertical menu">
	...
	<a href="<?php echo e(url('administrasi')); ?>" class="icon item">
