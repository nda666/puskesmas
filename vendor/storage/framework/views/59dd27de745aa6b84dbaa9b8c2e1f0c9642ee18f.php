...
<i class="big icons">
<i class="icon orange database"></i>
<i class="icon corner user"></i>
</i>
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/dokter/resep-sudah.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<div class="datatable-container">
	<table data-token="<?php echo e(csrf_token()); ?>"
		data-source="<?php echo e(url('dokter/json/resep_sudah')); ?>"
