...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/dokter/resep-sudah-view.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<div class="ui active tab vertical segment" data-tab="data-konsultasi">
		...
		<div class="datatable-container">
			<table id="data-konsultasi" class="ui definition unstackable blue single line celled table" width="100%"
				...
				data-source="<?php echo e(url('dokter/json/resep_sudah_view/'. $pasien->id)); ?>">
				<thead>
					<th></th>
					<th>ID</th>
