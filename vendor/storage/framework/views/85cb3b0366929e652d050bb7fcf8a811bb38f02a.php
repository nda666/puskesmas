<?php $__env->startSection('title','Sudah Konsultasi'); ?>
<?php $__env->startSection('content_title','Sudah Konsultasi'); ?>
...
<div class="ui blue top attached segment breadcrumb">
	<div class="ui breadcrumb">
		...
		<div class="active section"><i class="icon treatment"></i>Sudah Konsultasi</div>
	</div>
</div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content_sub_title', 'List Pasien yang Sudah Konsultasi'); ?>
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/sudah-konsultasi.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<div class="datatable-container">
	<table data-token="<?php echo e(csrf_token()); ?>"
		data-source="<?php echo e(url('administrasi/sudah-konsultasi/json/data-pasien')); ?>"
		data-token="<?php echo e(csrf_token()); ?>"
		data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>"
		data-update="<?php echo e(url('ajax/sudah-konsultasi/update')); ?>" data-delete="<?php echo e(url('ajax/sudah-konsultasi/delete')); ?>"
