...
<div class="datatable-container">
  <table id="rawat-jalan" class="ui unstackable celled table" data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>" data-token="<?php echo e(csrf_token()); ?>" width="100%" data-source="<?php echo e(url('apoteker/rawat-jalan/data-index?progres=0')); ?>">
    <thead>
      <tr>
