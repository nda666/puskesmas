<?php $__env->startSection('title','Resep Pasien - Sudah'); ?>
<?php $__env->startSection('content_title','Resep Pasien - Sudah'); ?>
<?php $__env->startSection('content_sub_title', 'List data pasien yang terdata mendapatkan resep obat'); ?>
...
<div class="ui blue top attached segment breadcrumb">
	<div class="ui breadcrumb">
		...
		<div class="active section"><i class="icon file text outline"></i>Resep Pasien - Sudah</div>
	</div>
</div>
<?php $__env->stopSection(); ?>
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/resep-sudah.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<div class="datatable-container">
	<table data-token="<?php echo e(csrf_token()); ?>"
		data-source="<?php echo e(url('administrasi/resep-sudah/json/data-pasien')); ?>"
