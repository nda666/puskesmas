<div class="ui grid">
  ...
  <div id="data-tab-tindakan" data-source="<?php echo e(url('/administrasi/rawat-jalan/data-detail-tindakan')); ?>" class="twelve wide stretched column">
    <form method="POST" action="<?php echo e(url('/administrasi/rawat-jalan/simpan-tindakan')); ?>" class="ui form form-tindakan">
    ...
    <div class="ui attached segment">
      ...
      <div class="disabled field">
        <button title="Hapus data konsultasi" data-action="<?php echo e(url('/administrasi/rawat-jalan/delete-tindakan')); ?>" data-id="" type="button" class="ui negative hapus-tindakan button" disabled="disabled"><i class="trash icon"></i>Hapus</button>
