<div class="ui small basic modal" id="modal-insert">
    ...
    <div style="width: 350px; margin: 0 auto;" class="ui segment">
      ...
      <form id="form-insert" data-delete="<?php echo e(url('apoteker/obat/delete')); ?>" data-update="<?php echo e(url('apoteker/obat/obat-detail')); ?>" class="ui equal width form"
  			data-token="<?php echo e(csrf_token()); ?>"
  			action="<?php echo e(url('apoteker/obat/create')); ?>">
  			<?php echo csrf_field(); ?>
