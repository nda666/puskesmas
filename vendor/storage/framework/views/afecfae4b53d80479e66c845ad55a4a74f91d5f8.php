 <?php $__env->startSection('title','Data dokter'); ?> <?php $__env->startSection('content_title','Management Dokter'); ?> <?php $__env->startSection('content_sub_title','Tambah dan Ubah Data Dokter'); ?> <?php $__env->startSection('content_title_icon'); ?>
<i class="big icons">
...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/dokter.min.js')); ?>"></script>
<?php $__env->stopSection(); ?> <?php $__env->startSection('content'); ?>
<div class="sixteen wide column computer">

	<div class="datatable-container">
		<table data-token="<?php echo e(csrf_token()); ?>" data-source="<?php echo e(url('administrasi/dokter/data-index')); ?>" data-token="<?php echo e(csrf_token()); ?>" data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>"  id="data-dokter" class="ui unstackable definition celled table" width="100%">
			<thead>
				<tr>
...
<?php echo $__env->make('administrasi.dokter.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
