...
<script type="text/javascript" src="<?php echo e(asset('/assets/js/administrasi/pendaftaran.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<div class="ui grid">
	<div class="sixteen wide mobile thirteen wide tablet ten wide computer centered column">
		...
		<form id="form-pendaftaran" class="ui form" method="POST" action="<?php echo e(url('administrasi/ajax/simpan-pendaftaran')); ?>">
