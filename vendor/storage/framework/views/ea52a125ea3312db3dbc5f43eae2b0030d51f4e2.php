<?php $__env->startSection('title','Rawat Jalan Pasien'); ?>
<?php $__env->startSection('content_title','Rawat Jalan Pasien'); ?>
<?php $__env->startSection('content_sub_title', 'Management Konsultasi, Tindakan, Resep, dan Progres Pasien'); ?>
...
<div class="sixteen wide column">
  ...
  <table id="rawat-jalan" class="ui unstackable definition celled table" data-lang="<?php echo e(asset('/assets/datatables/i18n/indonesian.json')); ?>" data-delete="<?php echo e(url('administrasi/rawat-jalan/delete-rawat-jalan')); ?>" data-token="<?php echo e(csrf_token()); ?>" width="100%" data-source="<?php echo e(url('administrasi/rawat-jalan/data-index?progres=0')); ?>">
    <thead>
      <tr>
        <th></th>
        <th>ID</th>
